...
**Golden rules:**
- ALWAYS check the local resolved-issues KB first: `~/.claude/skills/cyberark-expert/resolved-issues.md`
...
```
~/.claude/skills/cyberark-expert/tenants.md
```
...
Read `~/.claude/skills/cyberark-expert/resolved-issues.md` and search for the error code or keywords. If a match is found, present the cached resolution and verify it's still current.
...
After resolving any issue, append to `~/.claude/skills/cyberark-expert/resolved-issues.md`:
...
1. **Local resolved-issues KB** — `~/.claude/skills/cyberark-expert/resolved-issues.md`
